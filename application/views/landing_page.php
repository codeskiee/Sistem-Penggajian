   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">Manajemen Gaji</a>
            ...
            <div class="layer">
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        <div>
                           <h2>Website Aplikasi Kelompok 9 <br> Manajemen Gaji Pegawai</h2>
                        </div>
                        <p>aplikasi ini dipergunakan untuk membantu perusahaan dalam manajemen penggajian Pegawai secara efektif , efisien serta aktual</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi singkat tentang website Manajemen Gaji Pegawai
               </div>
            </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel1">Aplikasi ini dibuat untuk membantu perusahaan dalam proses admministrasi penggajian Pegawai</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel4">Cetak slip gaji, lupa password, login Pegawai</div>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/Logo BSI.png" class="rounded-square w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">Kelompok 9</div>
                           <div class="bio">Seorang Mahasiswa Informatika</div>
                           <div class="Job">Universitas Bina Sarana Informatika</div>
                           <div class="social_links">
                              <div class="social">
                                 <a href="https://github.com/Bongsky217" target="_blank"><i class="fab fa-github" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                              <a href="https://www.instagram.com/0obo0ng/" target="_blank"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                                 <a href="https://www.facebook.com/Rian Sptra/" target="_blank"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright & copy Boostrap SB Admin 2 & Rian Saputra | Aplikasi Sistem Manajemen Gaji 2024 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
